...
class Banner extends React.Component {
  render() {
    const childrenData = [
      { children: { title: { children: "Sem Tortor Mollis Aenean" }, content: { children: 'Donec' +
      ' id elit mi non porta gravida et eget metus. Vivamus sagittis lacus vel augue laoreet' +
      ' rutrum'}, button: { children: 'EXPLORE' } } },
      { children: { title: { children: 'Hoy es un buen dia' }, content: { children: 'Donec' +
      ' id elit mi non porta gravida et eget metus. Vivamus sagittis lacus vel augue laoreet' +
      ' rutrum'}, button: { children: 'Learn More' } } },
    ];
    const defaultImg = [
